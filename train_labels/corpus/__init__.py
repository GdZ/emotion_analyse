...
BAYES_PROCESSING_TRAIN_FILE_NAME = 'processing_train_bayes.txt'
BAYES_PROCESSING_TEST_FILE_NAME = 'processing_test_bayes.txt'
...
BAYES_TRAIN_LABEL_FILE_NAME = 'train_labels_bayes.csv'
BAYES_TRAIN_LABEL_CSV = ROOT_PATH + BAYES_TRAIN_LABEL_FILE_NAME
BAYES_TEST_LABEL_FILE_NAME = 'test_labels_bayes.csv'
...
LABEL_TRAIN_FILE_NAME = 'y_labels.txt'
LABEL_TEST_FILE_NAME = 'yt_labels.txt'
BAYES_LABEL_TEST_FILE_NAME = 'test_labels_bayes.txt'
